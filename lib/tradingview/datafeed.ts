import { SUPPORTED_RESOLUTIONS, AVAILABLE_SYMBOLS } from './config';
import { generateMockBars, type Bar } from './mockData';
import type {
  IBasicDataFeed,
  OnReadyCallback,
...
export const datafeed: IBasicDataFeed = {
  ...
  getBars: (
    ...
    try {
      const bars = generateMockBars(symbolInfo.name, resolution, from * 1000, to * 1000);
