  ...
  return (
    <footer className="bg-bg-primary border-t border-border-color">
      <div className="max-w-content mx-auto px-6 py-16">
        <div className="grid grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <HermesLogoIcon className="w-10 h-10" />
            </Link>
            <p className="text-sm text-text-secondary">{t('Trade everything, spend everywhere')}</p>
          </div>
        ...
        <div className="my-16 flex justify-center opacity-5">
          <span className="font-gilroy font-extrabold text-[200px] leading-none tracking-tighter">
            HERMES
          </span>
        </div>
