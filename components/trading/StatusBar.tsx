  ...
  return (
    <footer className="h-8 flex items-center justify-between px-4 bg-[#0b0e11] border-t border-[#1a1d26] text-xs">
      ...
      <div className="flex items-center gap-4 text-[#848e9c]">
        ...
        <span>
          Buys/Sells:{" "}
          <span className="text-white font-mono">{statusData.buys}</span>
      ...
      <div className="flex items-center gap-3">
        {/* Widget buttons */}
        <button className="text-[#848e9c] hover:text-white transition-colors" title="Toggle Spot Volume Widget">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
        </button>
        <button className="text-[#848e9c] hover:text-white transition-colors" title="Add News Widget">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* Social Links */}
        <Link href="https://x.com/HermesX" target="_blank" className="text-[#848e9c] hover:text-white transition-colors">
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
          </svg>
        </Link>
        <Link href="https://discord.gg/hermes" target="_blank" className="text-[#848e9c] hover:text-white transition-colors">
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <Link href="https://t.me/HermesX" target="_blank" className="text-[#848e9c] hover:text-white transition-colors">
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex items-center gap-1">
          ...
          <span className={`w-2 h-2 rounded-full ${statusData.status === "Online" ? "bg-[#0ecb81]" : "bg-[#f6465d]"}`} />
        </div>
      </div>
    </footer>
  );
