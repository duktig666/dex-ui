      ...
      {formattedPositions.map((pos) => {
        ...
        return (
          ...
          >
            ...
            <div className="text-right text-white font-mono">${formatPrice(pos.notionalValue, 2)}</div>
      ...
      {twapOrders.map((order, idx) => {
        ...
        return (
          ...
          >
            ...
            <div className={cn(
              "text-right",
              status === "running" ? "text-[#2962ff]" :
              status === "completed" ? "text-[#0ecb81]" : "text-[#f6465d]"
            )} title={terminatedReason}>
              {status === "terminated" && terminatedReason === "cancelled" ? "Cancelled" :
        ...
        return (
          ...
          >
            ...
            <div className={cn(
              ...
              order.status === "active" ? "text-[#2962ff]" :
              order.status === "triggered" ? "text-[#0ecb81]" :
              order.status === "cancelled" ? "text-[#f6465d]" : "text-[#848e9c]"
            )}>
              {order.status}
            </div>
            <div className="text-right text-[#848e9c]">
        ...
        return (
          ...
          >
            ...
            <div className={cn(
              ...
              {isPositive ? "+" : ""}{formatPrice(payment, 4)} USDC
            </div>
            <div className="text-right text-[#848e9c]">
...
export function AccountPanel() {
  ...
  const tabs: { value: TabType; label: string; count?: number }[] = [
    ...
    { value: "trailing", label: "Trailing", count: activeTrailingCount },
