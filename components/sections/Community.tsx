    ...
    <section className="py-32 bg-bg-secondary relative overflow-hidden">
      ...
      <div className="max-w-content mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Join the community and learn how other people get the most out of Hermes.
          </motion.p>
        </div>
        ...
        >
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <span className="text-white font-medium">Looking to collaborate? Get in touch</span>
            </div>
            <svg
